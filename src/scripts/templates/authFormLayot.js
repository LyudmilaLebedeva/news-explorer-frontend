...
<form class="form">
    ...
    <p id="signin-email-error" class="form__input-error"></p>
    ...
    <p id="signin-password-error" class="form__input-error"></p>

    <p class="form__error"></p>
    <input name="submit" type="submit" class="form__submit" value="Войти" />
    <p class="form__or">
